...
def generar_respuesta(question,partido):
    ...
    #openai_api_key = "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"
    embeddings_model = OpenAIEmbeddings(openai_api_key=openai_api_key)

    client = qdrant_client.QdrantClient("https://a522fdf3-d7ce-4992-aed9-b98bb6e60886.us-east-1-0.aws.cloud.qdrant.io",
